...
import ReadingQItem from './ReadingQitem.jsx';
...
email or other internet applications at work, the number of required
username/password combinations may surpass 30. Some of these
accounts demand that you use a specific number of symbols and digits,
while others require you to change your password every 60 days. When
you add to this list the codes needed to access things like ATMs, home
alarm systems, padlocks, or voicemail, the number of passwords becomes staggering. The feeling of
frustration that results from maintaining a memorized list of login credentials has grown so prevalent that it
...
to the SSO account.
Furthermore, if a hacker can crack the SSO password, he or she will then have access to all of
the linked accounts. Users who rely on password management software are susceptible to the same
problems, but they also incur the added threat of passwords being compromised because of computer
theft.
...
eliminate the need for people to remember passwords, the use of biometrics raises ethical
